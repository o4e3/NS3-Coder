...
output = '/home/gpuadmin/ns3coder/psh/data_cleaning/X/model-library.pdf'

if os.path.exists('/home/gpuadmin/ns3coder/psh/data_cleaning/X/libDB') :
    ...
    vectorstore_path = '/home/gpuadmin/ns3coder/psh/data_cleaning/X/libDB'
    ...
    if os.path.exists(output):
        ...
        pdf_folder = '/home/gpuadmin/ns3coder/psh/data_cleaning/X'  # PDF들이 들어 있는 폴더 경로
...
# 예시 질의
input_text = "Explain in detail the purpose and application examples for FdNetDeviceHelper among the helper libraries."
